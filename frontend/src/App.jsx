...
import { AddCommercial } from "./admin/pages/commercial/AddCommercial.jsx";
...
import { AddAmenityCommercial } from "./admin/pages/commercialAmenity/CommercialAmenity.jsx";
import { Update } from "./admin/pages/commercialAmenity/Update.jsx";
import { View } from "./admin/pages/commercialAmenity/View.jsx";

const App = () => {
  return (
    <Routes>
      <Route path="/" element={<Home />} />
      <Route path="/home" element={<ProjectDetails />} />
