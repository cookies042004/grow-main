...
export const Brochure = () => {
  ...
  const [formData, setFormData] = useState({ name: "", email: "", phone: "", reason: "", dealer: "" });
  ...
  return (
    <Layout>
      <div className="brochurebanner flex flex-col items-center justify-center">
        <h1 className="font-dmsans font-medium text-white text-3xl lg:text-5xl mt-10 lg:mt-20">Brochure</h1>
      </div>

      <div>
        <h1 className="font-roboto text-3xl text-[#1d2a3b] lg:text-4xl font-medium py-8 text-center">Our Brochures</h1>
          ...
          {brochures.length > 0 ? (
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 py-20">
              {brochures.map((brochure) => (
                <div key={brochure._id} className="relative group border rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
                  <img src={brochure.image} alt={brochure.name} className="h-64 w-full object-contain" />
                  ...
                  <h4 className="text-center text-xl font-semibold py-3">
                    {brochure.name.length > 20 ? `${brochure.name.substring(0, 20)}...` : brochure.name}
                  </h4>
                </div>
              ))}
            </div>
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <FormControl fullWidth required>
                ...
                <Select label="Reason" name="reason" value={formData.reason} onChange={handleChange}>
              ...
              <FormControl fullWidth required>
                ...
                <Select label="Are you a dealer" name="dealer" value={formData.dealer} onChange={handleChange}>
