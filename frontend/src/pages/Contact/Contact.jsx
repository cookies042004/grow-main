      ...
      <div className="my-10">
        ...
        <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-10 my-10">
          ...
          <div className="map-container relative w-full h-[400px]">
            ...
            ></iframe>
            <div className="absolute bottom-5 left-5 bg-white p-3 shadow-lg rounded-[10px] max-w-xs">
              <h2 className="font-sans text-xl text-[#1d2b3a] font-semibold">
                Our Office Location
              </h2>
              <p className="font-sans text-md text-[#5B5B5B]">
          ...
          <div className="map-container relative w-full h-[400px]">
            ...
            <div className="absolute bottom-5 left-5 bg-white p-3 shadow-lg rounded-[10px] max-w-xs">
              ...
              <p className="font-sans text-md text-[#5B5B5B]">
                Plot No. XX-20, Near XYZ Mall, Sector-50,
        ...
        <div className="grid sm:grid-cols-12 py-10 px-5">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-4 flex justify-center bg-white m-5 px-3 lg:px-4 py-4 lg:py-6 rounded-[24px] shadow-lg">
            <div className="flex flex-col gap-3 lg:gap-5  justify-center items-center">
              ...
              <p className="font-sans font-semibold text-[#1d2b3a] text-lg">Office</p>
              <p className="font-sans text-lg text-gray-600 font-bold">
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-4 flex justify-center bg-white m-5 px-2 lg:px-4 py-4 lg:py-6 rounded-[24px] shadow-lg">
            <div className="flex flex-col gap-3 lg:gap-5 justify-center items-center">
              ...
              <p className="font-sans text-lg text-gray-600 font-bold">
                Call us for any inquiries or concerns.
              </p>
              <p className="font-sans text-md text-[#5B5B5B] text-center">
                +91 9876543210, +91 1122334455
              </p>
            </div>
          </div>
        </div>
